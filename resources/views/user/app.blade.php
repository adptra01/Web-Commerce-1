    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
            <div class="font-weight-bold">
                <a href="{{ route('home') }}" class="js-logo-clone">THANKS DREAMS</a>
            </div>
        </div>
...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-12">
                <ul class="list-unstyled">
                    <p>Kami hadir dengan jangkauan yang lebih luas. Jangan lupa untuk mengunjungi kami secara berkala untuk melihat koleksi terbaru kami. Kami akan senang jika Anda menjadi pelanggan setia kami!</p>
                </ul>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-lg-4">
        <div class="block-5 mb-5">
            ...
            <ul class="list-unstyled">
                <li class="address">
                    {{ $lokasi->detail ?? 'Jambi, Sumatera Selatan, Indonesia' }}
                </li>
