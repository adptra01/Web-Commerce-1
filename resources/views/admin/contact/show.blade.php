<x-apps>
    ...
    <div class="container">
        <div class="mb-3">
            <span class="font-weight-bold text-dark">Nama Lengkap : </span>
            <p>{{ $contact->name }}</p>
        </div>
        <div class="mb-3">
            <span class="font-weight-bold text-dark">No. Telp : </span>
            <p>{{ $contact->telp }}</p>
        </div>
        <div class="mb-3">
            <span class="font-weight-bold text-dark">Pesan : </span>
            <p>{{ $contact->message }}</p>
        </div>
    </div>
</x-apps>
