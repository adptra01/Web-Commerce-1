<x-apps>
    <x-slot name="title">Perlu Dikirm</x-slot>
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800 font-weight-bold">TRANSAKSI PERLU DIKIRM</h1>
        @if (session('success'))
        ...
        @else
            <div class="media bg-primary rounded mb-3 text-white p-3">
                <img class="align-self-center mr-3" width="230px" src="/layouts/drawKit/vector (7).svg"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ route('admin.transaksi.detail', ['id' => $order->id]) }}"
                                        class="btn btn-primary btn-sm">Input No Resi
                                    </a>
                                </div>
                            </td>
                        </tr>
