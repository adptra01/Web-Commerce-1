                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.transaksi.detail',['id'=>$order->id]) }}">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">{{ $order->invoice }} - {{ $order->nama_pemesan }} - </div>
                                        <span class="font-weight-bold">Rp. {{ number_format($order->subtotal + $order->ongkir,2,',','.') }}</span>
                                    </div>
                                </a>
                                @endforeach --}}
                            </div>
