        ...
        <div class="media bg-primary rounded mb-3 text-white p-3">
            ...
            <div class="media-body">
                <small>
                    ...
                    Harap perhatikan detail dan kelengkapan dari pesanan yang dibuat, seperti nama, alamat, nomor
                    telepon, jumlah, warna, ukuran, dan lain-lain. Jika ada pesanan yang tidak jelas, kurang lengkap,
                    atau tidak sesuai dengan stok produk, harap segera menghubungi pelanggan untuk mengkonfirmasi atau
                    mengubah pesanan tersebut.
                </small>
            </div>
        </div>
    </div>
