      ...
      @else
          <div class="media bg-primary rounded mb-3 text-white p-3">
              ...
              <div class="media-body">
                  <small> <strong>Peringatan!!!</strong><br>Sebagai admin toko, Anda dapat menambahkan, mengedit, atau menghapus kategori produk yang dijual di toko Anda. Anda harus memasukkan informasi produk secara lengkap dan
