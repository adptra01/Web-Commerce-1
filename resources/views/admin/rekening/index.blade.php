      ...
      @else
          <div class="media bg-primary rounded mb-3 text-white p-3">
              ...
              <div class="media-body">
                  <small> <strong>Peringatan!!!</strong><br>Pada menu admin bagian no.rekening, Anda dapat melihat dan mengubah nomor rekening bank yang digunakan untuk menerima pembayaran dari pelanggan. Nomor rekening ini harus sesuai dengan nama dan identitas Anda sebagai admin. Terima kasih atas kerjasama Anda.
                  </small>
              </div>
          </div>
      @endif
