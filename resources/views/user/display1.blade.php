...
@section('content')
    ...
    <div class="site-section">
        ...
        <h2 class="text-center text-primary"><strong>MENJAGA BAHAGIA SEPANJANG WAKTU</strong></h2>
        <div class="container pt-5">
            <div class="row">
                <div class="col-md"><img class="img-responsive" src="https://pethouse.joomlatema.net/images/dogs.jpg"
                        alt=""></div>
                <div class="col-md text-right">
                    <h4 class="text-primary">“<span class="text-primary">Kami Tahu</span> Bahwa <span
        ...
        <div class="container">
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 feature-text wow fadeInUp" data-wow-delay="0.1s"
                    ...
                    <h1 class="font-weight-bold text-primary mb-5">KAMI PETSHOP TERPECAYA</h1>
                    <div class="d-flex mb-5 wow fadeInUp" data-wow-delay="0.3s"
                        style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                        <i class="fa fa-globe text-primary fa-3x flex-shrink-0"></i>
                        <div class="ms-4">
                            <h5 class="font-weight-bold text-primary">Produk Asli</h5>
                            <p class="mb-0 text-primary">Menjamin kualitas terbaik yang siap memenuhi kebutuhan dan harapan
                                pelanggan kami</p>
                        </div>
                    </div>
                    <div class="d-flex mb-5 wow fadeIn" data-wow-delay="0.5s"
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0 text-primary">Layanan pengiriman JNE yang membantu kami mengirimkan semua
                                kebutuhan
                    ...
                    <div class="d-flex mb-0 wow fadeInUp" data-wow-delay="0.7s"
                        ...
                        <div class="ms-4">
                            ...
                            <p class="mb-0 text-primary">Anda dapat menghubungi kami kapan saja, baik siang maupun malam,
                                untuk
